    ...
    while 1:
        try:
            if cyr.flag:
                ...
                fps_label = "avg FPS: %.2f FPS: %.2f (excluding postprocessing %.2fms drawing %.2fms)" % (
                    avg_FPS, 1 / (end - start), (end_postprocessing - start_postprocessing) * 1000.0,
                    (end_drawing - start_drawing) * 1000.0)
